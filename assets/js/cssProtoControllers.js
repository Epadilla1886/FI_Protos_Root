...
app.controller('cssLayout1Controller', function() {
    ...
    this.features = {
        'Feature Set 1 - Layout 1': {
            html: "<ul class='left-border'><li>Make a file called <code>example.html</code><ul><li>Add an internal CSS stylesheet</li><li>In it, do the following:</li><li>Make a div, give it a class of 'feature_set_1_1'<ul><li>Make a set of 3 divs inside the above div, sitting side by side, that together take up 75% of the width of the body</li><li>Add appropriate ids or classes to perform the following operations:<ul><li>Give your divs a set height</li><li>Put 5% of space between the 1st and 2nd div via any method you wish</li><li>Put 5% of space between the 2nd and 3rd div without further altering the 2nd div</li><li>The three divs should all be on the same line, side by side </li></ul></li></ul></li><li>Make another div, give it a class of 'feature_set_1_2'<ul><li>Make a set of 3 divs inside the feature_set_1_2, each with 25vw width</li><li>The three divs should all be on the same line, side by side </li><li>Add borders to all 3 divs with 1 css statement, without affecting any other div in this example</li><li>Add padding top and bottom to the first div with 1 CSS statement</li><li>Add padding top and right to the second div with 1 CSS statement</li><li>Using the Chrome Dev Tools Inspector, add padding to the 3rd div in any combination, as long as each side has a different value.<ul><li>Copy the padding to your internal style sheet</li></ul></li>    </ul></li><li>Make another div, give it a class of 'feature_set_1_3'<ul><li>Give the div a set height in pixels</li><li>Give it 3 child divs, each with 100pixels of width</li><li>The three divs should all be on the same line, side by side </li><li>Give the first 25% height</li><li>Give the second 25 vh height</li>    <li>Give the third another height value beside pixel, %, or viewport height.</li></ul></li></ul></li></ul>"
        },
        'Feature Set 2 - Layout 2': {
            html: "<ul class='left-border'><li>Create a file called <code>nav.html</code><ul><li>Create an internal style sheet </li><li>Add a <code>&lt;nav&gt;</code> element and closing tag, put the remaining code from this featureset inside the nav element</li><li>Make a UL / LI element construct<ul><li>With the following hyperlinks (none of these files exist, don't worry)<ul><li>home : links to home.html </li><li>about us : links to about_us.html</li><li>our menu : links to our_menu.html</li><li>contact us : links to contact_us.html</li></ul></li><li>Remove the bullet points</li><li>The nav should be displayed horizontally</li><li>Add a border with appropriate spacing around the menu items</li><li>Add padding to space the border from the text</li><li>Capitalize the text within the menu WITHOUT changing the text in your element directly. <i>Use CSS</i></li><li>Add margin sufficient to space the menu items out relatively evenly across the page</li><li>Resize your page.  What happens?  Tweak this untill it works correctly at most sizes.<ul><li>have you tried making the font size responsive?  This might help.  <b>Explore!</b></li></ul></li></ul></li></ul></li></ul>"
        },
        'Feature Set 3 - Layout 3': {
            html: "<ul class='left-border'><li>Create a file called <code>gallery.html</code><ul><li>Add an internal style sheet</li><li>Add 5 photos that feature yourself in them.  If you are a complete recluse, use any photos.<br></li><li>Add CSS to your stylesheet that allows all 5 photos to sit side by side on the same line, as well as margin/padding/border (as you wish) to space them out from one another<ul><li>If resizing the photos is required, make sure they maintain their previous aspect ratio <i>(The pictures should not appear distorted)</i></li></ul></li><li>Have each photo link to the full size photo directly.  Should open via a hyperlink.  Only clicking the photo should open this link.</li></ul></li></ul>"
        }
    }
});
...
app.controller('cssLayout2Controller', function() {
    this.title = ['CSS Design & Layout 2: CSS Positioning and CSS Floating', 'css_design_layout_2'];
    this.description = "<p>Expand your understanding of content layouts and how they pertain to web page design. This prototype will cover positioning and floating in CSS</p><p>This prototype is based on the information that you obtained through the following resources <b>(If you haven't gone through these then please do so now).</b></p>";
    this.branch = 'css_dl2';
    this.protoId = 7;
    ...
    this.features = {
        ...
        'Feature Set 4 - Footer': {
            html: "<h4>Create a basic footer at the bottom of your page</h4><ul class='left-border'><li>Use the <code>&lt;footer&gt;</code> tag to create a footer after your other content<ol><li>Its height should be about <code>20%</code> of the view area<ol class='nested-1'><li>All sections together should equal <code>100%</code> of the height of the view area<ol class='nested-2'><li>Header ~ <code>20%</code></li><li>Section fs-2 ~ <code>30%</code></li> <li>Section fs-3 ~ <code>30%</code></li><li>Footer ~ <code>20%</code></li></ol></li><li>Yours heights can vary just as long as they all equal <code>100%</code> combined</li></ol></li><li>Add some generic content to your footer</li><li>Add a background color to match your header</li></ol></li></ul>"
        },
        'Feature Set 5 - Gutters': {
            html: "<h4>Create gutters on both sides of all your elements</h4><ul class='left-border'><li>Wrap all your content from header to footer in a div tag<ol class='nested-1'><li>Give the div a class of container</li><li>Set its width to <code>70vw</code><ol class='nested-1'><li>Change the width of your header, sections and footer to <code>100%</code> (if that's not what you are using already)</li><li>Find a way to center your container on the page (horizontally)</li></ol></li><li>Once you center your container, all your content should be centered on the page</li><li>This will create a <code>15vw</code> gutter on each side of your content</li></ol></li></ul>"
        }
...
app.controller('cssSelectorsController', function() {
    this.title = ['CSS Selectors: Group, Descendant, Content, State, Link Selectors, Cascading and Specificity', 'css_selectors'];
    ...
    this.features = {
        ...
        'CSS Selectors - Easy (Well, "easier")': {
            html: "<ol class='left-border'><li>Using the provided <code>easy.html</code> file, recreate the image below<ol class='nested-1'><li><strong>DO NOT</strong> change the HTML in <strong>ANY</strong> way. Don't touch even one letter!</li><li>This will require you to use element selectors, group selectors and pseudo CSS selectors</li></ol></li><li>Create an external css style sheet named <code>style-easy.css</code><ol class='nested-1'><li>The link has already been added to the HTML so make sure to name it as shown</li></ol><a href='assets/images/prototypes/css_selectors/easy.png' target='_blank'><img src='assets/images/prototypes/css_selectors/easy.png' alt='Contact an Instructor if you see this (easy-1)'></a></li></ol><h4>Feature Set 1 - Body Size and Header</h4><ol class='left-border'><li>Give the body element a set (fixed) <em>height</em> and <em>width</em><ul><li>Height = <code>600px</code></li><li>Width = <code>1200px</code></li></ul></li><li>Center the content of the header</li><li>Give the header element:<ol class='nested-1'><li>A border, just on the bottom, <code>3px</code> thick</li><li>A background color <span class='label lightblue-bg'>light blue</span></li></ol></li><li>For the ul that represents the navigation:<ol class='nested-1'><li>Take away the bullet points</li><li>Make sure it is properly centered (some padding maybe?)</li><li>Make the list horizontal</li><li>Using pseudo selectors<ol class='nested-2'><li>Make the first and third list items <span class='lightgreen-txt'>light green</span></li><li>Make the second and fourth <span class='green-txt'>green</span></li></ol></li></ol></li></ol><h4>Feature Set 2 - Center Section</h4><ol class='left-border'><li>For the whole middle section, center all the content</li><li>For the \"Main Content - Square Divs\" section<ol class='nested-1'><li>give the three divs the following dimensions:<ul><li>Height = <code>80px</code></li><li>Width = <code>80px</code></li></ul></li><li>Give the divs the appropriate background color to match their text</li><li>Give the three divs a border with a radius and make it <code>3px</code> thick</li><li>Position the divs as shown in the image above</li></ol></li><li>For the \"Main Content - Paragraphs\" section<ol class='nested-1'><li>Change the font color of the three paragraphs to <span class='lavender-txt purple-bg label'>lavender</span></li><li>Add a dark gray background color to the first and third paragraphs<ol class='nested-2'><li>Add some top and bottom padding to those same paragraphs (<code>4px</code>)</li></ol></li><li>For the middle paragraph:<ol class='nested-2'><li>Change the font color to <span class='label black-bg'>white</span></li><li>Change the background color to <span class='label blue-bg'>blue</span><ol><li>Make it so the background color only surrounds the text and doesn't reach across the page</li></ol></li><li>Add some padding to all sides (<code>4px</code>)</li><li>Increase the font size to about <code>22px</code></li></ol></li></ol></li></ol><h4>Feature Set 3 - Footer</h4><ol class='left-border'><li>Center the content of the Footer</li><li>Change the footer background color to be the same as the header</li><li>Add some extra padding on all sides to the footer (about <code>10px</code>)</li><li>Make the h1 element <span class='dark-blue-txt'>dark blue</span></li><li>For the paragraph in the footer:<ol class='nested-1'><li>Change the font color <span class='text-danger'>Red</span></li><li>Make the font <strong>Bold</strong></li><li>Make the font size <span class='larger-txt'>Bigger</span>... let's say <code>18px</code></li><li><u>Uderline the whole paragraph</u></li></ol></li><li>That is it, your page should resemble the image above</li></ol>"
        },
        'CSS Selectors - Hard (Well, "harder")': {
            html: "<ol class='left-border'><li>Using the provided <code>hard.html</code> file, recreate the image below<ol class='nested-1'><li><strong>DO NOT</strong> change the HTML in <strong>ANY</strong> way. Don't touch even one letter!</li><li>This will require you to use element selectors, group selectors and pseudo CSS selectors</li></ol></li><li>Create an external css style sheet named <code>style-hard.css</code><ol class='nested-1'><li>The link has already been added to the HTML so make sure to name it as shown</li></ol></li><li>There are no step by step instructions for this one, just some guidelines that will be checked for<a href='assets/images/prototypes/css_selectors/hard-1.png' target='_blank'><img src='assets/images/prototypes/css_selectors/hard-1.png' alt='Contact an Instructor if you see this (hard-1)'></a></li></ol><h4>Notes For Hard</h4><ol class='left-border'><li><strong>Note:</strong> in the second image, when you hover over \"Menu Item 1\" there is a drop down menu</li><li>The main menu and sub menu items also highlight with gray on hover<a href='assets/images/prototypes/css_selectors/hard-2.png' target='_blank'><img src='assets/images/prototypes/css_selectors/hard-2.png' alt='Contact an Instructor if you see this (hard-2)'></a></li><li>Guidelines that will be checked:<ol class='nested-1'><li>Body width set to <code>790px</code></li><li>Cat image is 25% of the vw but not to exceed <code>150px</code></li><li>Article has <code>50%</code> of the  width</li><li>Aside has <code>50%</code> of the  width</li><li>Footer is <code>20%</code> of the view height</li><li>ALL Colors used:<ul><li>Black</li><li>Blue</li><li>Dark Gray</li><li>Green</li><li>Red</li><li>White</li></ul></li><li class='clean-list'>The list above is just some of the key things that will be checked for. You will need to figure out padding, margins, borders, etc and how to target the individual and groups of elements using only css selectors. Do your best to match the images exactly.</li></ol></li></ol>"
        }
    }
...
app.controller('cssBsReduxController', function() {
    ...
    this.features = {
        'Getting Started': {
            html: "<ol class='left-border'><li>An <code>index.html</code> file has been included with this prototype and is located in the <code>css_bootstrap_redux</code> folder</li><li>Also included is an <code>images</code> folder</li><li>All the infornation you need to complete the feature sets can be found <a href='http://getbootstrap.com/' target='_blank'>HERE</a></li><li>You will need both the CSS and JavaScript Bootstrap CDNs <ul><li><b>NOTE:</b> The JS for Bootstrap requires the jQuery CDN, make sure to include jQuery before the Bootstrap JS CDN</li><li><b>jQuery CDN:</b> <code>&lt;script src=\"https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js\"&gt;&lt;/script&gt;</code></li></ul></li></ol>"
        },
        ...
        'Feature Set 2 - Bootstrap Carousel': {
            html: "<ol class='left-border'><li>Add a Bootstrap Carousel module to your page</li><li>Add 5 images of yourseslf or something you enjoy, and place the images into the <code>images</code> folder</li><li>Make sure it has a dot for each photo, appropriately linked</li>   </ol>"
        },
