...
app.controller('htmlResponsiveDesignController', function() {
    ...
    this.description = "<p>Building from previous prototypes this prototype will introduce you to responsive design. You will be modifying a form to scale properly onto a mobile device.</p><p>This prototype is based on the information that you obtained through the following resources <b>(If you haven't gone through these then please do so now).</b></p>";
